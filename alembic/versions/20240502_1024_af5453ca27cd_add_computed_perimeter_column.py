...
def upgrade():
    ...
    op.add_column('farm_field', sa.Column('perimeter', sa.Float(), sa.Computed('ST_Perimeter(coordinates, true)', ), nullable=True, comment='Perimeter in meters'), schema='coffee')
    op.alter_column('farm_field', 'area',
